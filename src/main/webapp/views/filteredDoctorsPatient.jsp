<%@ page language="java" contentType="text/html; charset=UTF-8"
    ...
    <%@page import="com.LiveDoc.pojo.Doctors" %>
<!DOCTYPE html>
<html lang="en">
  <head>
    <meta charset="UTF-8" />
        ...
        <div class="container">
          ...
          >
            <a
              ...
              href="/patients/showAllDoctors/<%= userId %>"
              >Go Back</a
            >
          </div>
        </div>
      ...
      <main role="main" class="pb-3">
        ...
        <div class="container pt-3">
          ...
          <table class="table table-bordered table-striped" style="width: 100%">
            ...
            <tbody>
            <%
            List<Doctors> list = (List<Doctors>)request.getAttribute("doctorList");
            for(Doctors objDoctor : list)
            {
            %>
              <tr>
