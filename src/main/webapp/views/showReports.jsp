<%@ page language="java" contentType="text/html; charset=UTF-8"
    ...
    <%@page import="com.LiveDoc.pojo.Reports" %>
<!DOCTYPE html>
<html lang="en">
  <head>
    <meta charset="UTF-8" />
      ...
      <main role="main" class="pb-3">
        ...
        <div class="container pt-3">
          ...
          <table class="table table-bordered table-striped" style="width: 100%">
            ...
            <tbody>
            <%
				List<Reports> list = (List<Reports>)request.getAttribute("reportList");
				for(Reports objReport : list)
					{
			%>
              <tr>
                <td ><%= objReport.getDoctorId() %></td>
                <td ><%= objReport.getMedicinePrescribed() %></td>
                <td ><%= objReport.getDoctorComment() %></td>
              </tr>
				<%
					}
				%>
