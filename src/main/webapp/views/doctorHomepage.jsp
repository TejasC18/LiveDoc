        ...
        <div class="container">
          ...
          >
            <ul class="navbar-nav ms-auto pt-2 pt-lg-0 font-base">
              ...
              <li class="nav-item px-2">
                <a class="nav-link" href="/doctor/contact/<%= userId %>">Contact Us</a>
              </li>
              <li class="nav-item px-2">
                <a class="nav-link" href="/doctor/appointments/<%= userId %>">Appointments</a>
              </li>
              <li class="nav-item px-2">
                <a class="nav-link" href="/doctor/profile/<%= userId %>">Profile</a>
              </li>
            </ul>
            <a
