        ...
        <div class="container">
          ...
          >
            <ul class="navbar-nav ms-auto pt-2 pt-lg-0 font-base">
              ...
              <li class="nav-item px-2">
                <a class="nav-link" href="/admin/showAllDoctors/<%= userId%>">Doctors</a>
              </li>
              <li class="nav-item px-2">
                <a class="nav-link" href="/admin/addDoctor/<%= userId%>">Add Doctor</a>
              </li>
              <li class="nav-item px-2">
                <a class="nav-link" href="/admin/removeDoctor/<%= userId%>">Remove Doctor</a>
              </li>
            </ul>
            <a
