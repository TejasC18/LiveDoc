        ...
        <div class="row justify-content-center">
          <div class="col-md-6 col-lg-4">
            <div class="login-wrap p-0">
              <p class="w-100 text-center">&nbsp;Specify user type&nbsp;</p>
              <div class="social d-flex text-center">
                <a href="registerPatient" class="px-2 py-2 mr-md-4 rounded"
                  >Patient</a
                >
                <a href="registerDoctor" class="px-2 py-2 mr-md-4 rounded"
                  >Doctor</a
                >
              </div>
            </div>
