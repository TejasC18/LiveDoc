<%@ page language="java" contentType="text/html; charset=UTF-8"
    ...
    <%@page import="com.LiveDoc.pojo.Appointment" %>
<!DOCTYPE html>
<html lang="en">
  <head>
    <meta charset="UTF-8" />
        ...
        <div class="container pt-3">
          ...
          <table class="table table-bordered table-striped" style="width: 100%">
            ...
            <%
				...
				for(Appointment objAppointment : list)
					{
			%>
              <tr>
                <td ><%= objAppointment.getPatientId() %></td>
                <td ><%= objAppointment.getProblem() %></td>
                <td ><%= objAppointment.getDate() %></td>
                <td ><%= objAppointment.getTime() %></td>
                <td>
                <div class="col-6 text-end">
             	 <a href="/doctor/generateReport/<%= objAppointment.getAppointmentId() %>/<%=userId %>" class="btn btn-warning btn-sm">Generate Report</a>
            	</div>
                </td>
              </tr>
				<%
